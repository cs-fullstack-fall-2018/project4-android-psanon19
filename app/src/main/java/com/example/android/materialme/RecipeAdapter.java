...
class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.ViewHolder>  {
    ...
    /**
     * Constructor that passes in the Recipe data and the context.
     *
     * @param RecipeData ArrayList containing the Recipe data.
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        ViewHolder(View itemView) {
            ...
            mDetailsText = itemView.findViewById(R.id.subTitleDetail);
        ...
        void bindTo(Recipe currentRecipe){
            ...
            mDetailsText.setText(currentRecipe.getDetails());

            // Load the images into the ImageView using the Glide library.
            Glide.with(mContext).load(
                    currentRecipe.getImageResource()).into(mRecipeImage);
        }
        ...
        public void onClick(View view) {
            ...
            detailIntent.putExtra("detail", currentRecipe.getDetails());
